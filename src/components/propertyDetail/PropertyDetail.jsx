...
const PropertyDetail = () => {
  ...
  const handleContactOwner = async (e) => {
    ...
    emailjs.sendForm("service_ei9rhuk", "template_d2vxskh", formRef.current, 'NVdcP7pD9txHkqSSN')
      .then((result) => {
    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <img src={`https://realestatebackend-dhki.onrender.com/images/${propertyDetail?.img}`} />
        </div>
        ...
        <div className={classes.contactForm} onClick={handleCloseForm}>
          <div className={classes.contactFormWrapper} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleContactOwner} ref={formRef}>
              ...
              <button onClick={() => {alert('Mail Send')}}>Send</button>
            </form>
